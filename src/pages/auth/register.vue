<template>
  <div class="space-y-2" v-loading="loadingState.value">
    <div class="flex justify-center">
      <img src="https://img.icons8.com/ios-filled/50/ffffff/spotify--v1.png" alt="spotify" class="mr-2" />
    </div>
    <div class="text-4xl text-white font-bold text-center w-full mb-10">Đăng ký để <br/>bắt đầu nghe</div>
    <form @submit.prevent="onSubmit">
      <div class="mt-10 flex flex-col gap-4">
        <label for="name" class="font-bold mb-[-10px]">Nhập tên người dùng</label>
        ...
        <button type="submit" :disabled="loadingState.value" class="w-full flex justify-center items-center text-black py-[14px] px-[50px] mt-3 bg-green-500 font-bold rounded-full transform hover:scale-105 hover:bg-green-400">
    ...
    <div class="flex justify-center items-center mt-10 relative">
      <hr class="border-gray-600 w-[calc(100%+200px)] mx-[-40px]">
      <span class="absolute px-2 bg-neutral-900 text-white">hoặc</span>
    </div>

    <button class="w-full flex justify-center items-center mt-10 border-2 border-gray-500 text-white py-[14px] px-[50px] bg-transparent font-bold rounded-full">
    ...
    <div class="mt-5 text-center font-bold text-gray-500">Bạn đã có tài khoản?<router-link to="/login" class="ml-4"><strong class="underline text-white">Đăng nhập tại đây</strong></router-link></div>
  </div>
</template>
